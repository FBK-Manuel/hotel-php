    ...
    <nav>
        ...
        <div class="list">
            <ul>
                ...
                <li><a href="Book.html" id="book">Book Now</a></li>
            </ul>
        </div>
    </nav>
...
//         $sql = "INSERT INTO tb_invoice (FirstName, LastName, Email, Check_in_date, Check_out_date, Room, Gender, Age) " .
//             "VALUES ('$firstname', '$lastname', '$email', '$check_in_date', '$check_out_date', '$room',  '$gender', '$age',)";
//         $result = $connection->query($sql);

//         if (!$result) {
//             # code...
//             echo '<script>alert("All fields are required!");</script>' . $connection->error;
//             break;
//         }
//         $firstname = "";
//         $lastname = "";
